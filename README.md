...
### Cliente
Aplicação com interface gráfica desenvolvida em **Java**, utilizando **JFrame (Swing)**, responsável pela interação com o usuário e pelas funcionalidades de **upload**, **download** e visualização da lista de arquivos disponíveis, além de exibir **barra de progresso**, mensagens de status e realizar a atualização automática em tempo real.
